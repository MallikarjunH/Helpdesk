...
//
//  Created by mallikarjun on 24/10/19.
...
{
    UIAlertController *alertController = [UIAlertController   alertControllerWithTitle:@"HELDESK" message:message  preferredStyle:UIAlertControllerStyleAlert];
